...
class Form{
    ...
    public function title($info,$value){
        ...
        //缩略图
        //$thumbstr ='</div></div>';
        $thumbstr .='<div class="layui-form-item"><label class="layui-form-label">封面图<br>尺寸678x300</label>';
    ...
    public function file($info,$value){
        ...
        $thumbstr ='<input type="hidden" name="'.$field.'" id="'.$field.'fval" value="'.$dataField.'"><div class="layui-upload">';
        $thumbstr .='<button type="button" class="layui-btn layui-btn-primary" id="'.$info['class'].'"><i class="icon icon-upload3"></i>点击上传</button>';
        $thumbstr .='<div class="layui-upload-list"><input type="hidden" id="'.$info['class'].'File"><p id="thumbText"></p>';
        $thumbstr .='<input class=" layui-input" value="'.$dataField.'" id="'.$field.'ffval"/>';
        $thumbstr .='</div></div>';
        $thumbstr.="<script> 
                        layui.use('upload', function () {
                            var upload = layui.upload;
